...
\section{Ancient History of Finance} 
  ...
  \subsection{Sumer}
    ...
    From this, we can understand that the origin of banks comes from a need to safely store grains, mainly barley, and so barley is by many considered to be the first official currency of the world. Another common type in Sumerian society was silver.\footnote{It's not quite certain how Sumerians had access to silver since precious metals were hard to find in Mesopotamia. It may have been through trade with neighboring civilizations. It is also not sure how the absolute value of silver was set as well. }, which has its own denominations. 
    ...
    There were other forms of money through different commodities, but they weren't used as much as a \textit{standard} per se. At this point, the concept of loans took off as well.
    ...
    With this explained, the modern banking system is established. 
  ...
  \subsection{Akkadian Empire and Ur III Period}

    Then, \textit{Sargon of Akkad} had established himself as ruler in 2350 BCE. 
    

    Then Assyria and Babylonia within it as an independent city-state with Hammurabi. 

    Bala taxation. 



  \subsection{Assyrian and Babylonian Empires}

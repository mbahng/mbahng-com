...
\section{Ancient History of Finance} 

    Some may argue that this section is not relevant, but to me it is. Later on we will be analyzing data like money supply, interest rates, and stock prices. However, I find myself questioning where all this came from, and why do we actually need this kind of system? To answer this, we need to take a deep dive into history.  

    Let's develop a bit of a taxonomy of the major periods of \textbf{prehistory}.\footnote{Since history is often imprecise, all the dates I mention will be approximate. } 
    \begin{enumerate} 
    ...
    After this, we have \textbf{protohistory}. During the Paleolithic era, humans were composed of groups of hunter gatherers (ranging in size from an extended family to no more than 100 people) that traveled around for food and shelter. With humans forming groups, there was some level of specialization of labor, where men might have hunted and women/children gathered. Whether it was within the tribe or between tribes, there was \textbf{bartering} already happening between humans. 

    It is important to distinguish what is and isn't money. For now, let's use the following definition. 
    ...
    At this point, civilization is not even developed yet, but during the advent of the Neolithic era around 9000 BCE where humans discovered agriculture, various hunter gatherers began to separate from their main groups and begin settlements, staring with those in the Fertile Crescent and others following rapidly. 

    \begin{definition}[Cradles of Civilization]
      This actually happened independently throughout the world at similar times, giving birth to the following major \textbf{cradles of civilization}. 
      \begin{enumerate}
        \item Mesopotamia  
        \item Egypt
        \item China 
        \item India
      \end{enumerate}
      Mesopotamia and Egypt composed up of a large part of the \textit{Fertile Crescent}, which is the crescent-shaped region of land stretching the two areas.\footnote{Each cradle went through its own development, but we will focus on one or at most two different civilizations at once. Going through all of them independently is not within the scope of these notes. }
    \end{definition}

  \subsection{Sumer}

    With the advent of agriculture, more groups abandoned hunter-gatherer practices to establish permanent settlements that could provide for much larger populations. This had several consequences. 
    \begin{enumerate}
      \item The domestication and possession of large animals resulted in a dramatic increase in social inequality since it allowed competition between households and resulted in inherited inequalities of wealth. This led to tribal leaders, chiefs, or small elite groups of people (though this was not pronounced until the Bronze age) which would later form into governments. 
      \item The surplus of grain and cattle allowed more sophisticated forms of bartering, though a common currency was not established yet and values can still be negotiated. 
      \item Bookkeeping of agricultural production was established, giving rise to the first accounting practices in humanity that tracked whether surplus had been gained. 
    \end{enumerate}
    The development of Mesopotamia where humanity consisted of multiple independent city-states was known as the \textit{Chalcolithic period} (9000-3500 BCE). Major city-states, whose names will become important, were Uruk, Ur, Kish and Eridu. 

    Around 3500 BCE, the ancient \textbf{Sumerians} (whose origin is not well known but was believed to have migrated) settled into Mesopotamia. While their origin is debated, they had complex societies and are considered the first ever civilization known to man. Let's elaborate on how humanity has evolved. 

    The society now had rulers that oversaw a decently sophisticated society, hinting at the formation of primitive governments. This was effective for development, since now humans can organize to work together on more sophisticated projects, like walled cities and temples used for religious practices, called \textit{ziggurats}. Therefore, a city would consist of tons of farmland surrounding a walled enclosure. Within the walls would be elevated buildings for citizens to live in, with an even higher elevated ziggurat in the middle. These elevations were necessary because of flooding. 
    ...
    One way to do this was use some form of currency like clay coins. You, as a farmer, can take your grains to a temple and exchange the grain for coins. Later on, you can come back to the temple and buy back the grain. This gave birth to the first banking system in civilization, but there was one problem. It was extremely easy to counterfeit these coins, since they're just little balls of hardened clay. 

    \begin{definition}[Bank Deposits in Sumer]
      ...
      \end{enumerate}
      At this point, you have an envelope to take back home and the priest has one kept in the temple. Given that you don't break the envelope, you can take it back to the temple at a future time, where both you can the priest can first take a look at the inscriptions to see that they match, then break open the envelopes to see that the coins inside match, and then you receive your 10 pounds of grain. This is essentially a deposit and can't be counterfeited. 
    \end{definition} 

    From this, we can understand that the origin of banks comes from a need to safely store grains, mainly barley. It turns out that the two most common types of currency was barley and silver.\footnote{It's not quite certain how Sumerians had access to silver since precious metals were hard to find in Mesopotamia. It may have been through trade with neighboring civilizations. } A \textbf{shekel} of silver is worth about 30 liters of wheat/barley, which is almost a year's worth for one person. 

    There may have been a fixed exchange rate between them, but in general

    At this point, the concept of loans took off as well.
    
    \begin{definition}[Loans and Interests in Sumer]
      ...
      \begin{enumerate}
        ...
        \item interest rates, which were explicitly put as a percentage or quantity of the loaned commodity, or if omitted, was presuemd to be common knowledge.\footnote{For cattle, which was often traded, the interest would be any offspring that they produced. }
      \end{enumerate}
    \end{definition}
    ...
    With the development of power, there were inevitably conflicts between the Sumerian city-states of Kish, Uruk, Ur, and Lagash.

  \subsection{Akkadian and Assyrian Empire}

    Then, \textit{Sargon of Akkad} had established himself as ruler in 2350 BCE. Then Assyria and Babylonia within it as an independent city-state with Hammurabi. 


  \begin{enumerate}
    \item (770 BCE) Coins are created in China. 
    \item (700 BCE) System of paper money devised in China. 
  \end{enumerate}

  \subsection{Babylonian Empire}

    Hammurabi. 

  \section{Modern History of Finance} 

...
\section{Interest Rates}
    ...
    \begin{definition}[Discrete Compounding Interest]
    ...
    \begin{definition}[Continuous Compounding Interest]
    ...
    \begin{lemma}[Interest Rates with Longer Loans]
  ...
  \subsection{Fed Funds Rate and Libor}
    ...
    \begin{definition}[Monetary Supply]
    ...
    \begin{example}[Monetary Supply of Various G20 Countries]
...
\section{Forward Contracts} 
    ...
    \begin{definition}[Profit-Loss Diagram]

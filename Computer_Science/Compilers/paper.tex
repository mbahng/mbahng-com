\documentclass{article}
  ...
  % external documents 
   ...
   \externaldocument[th-]{../Theory/paper}[https://mbahng.com/Computer_Science/Theory/paper.pdf] 
...
\include{sec/intro}
\include{sec/handwritten_scanners}
\include{sec/generated_scanners}
\include{sec/parsing} 
\include{sec/resolution}
\include{sec/type_checking}
\include{sec/tree_walk_interpreter}
\include{sec/bytecode_interpreter}
% \include{sec/tbd}

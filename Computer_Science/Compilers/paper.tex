...
\include{sec/lexing}
\include{sec/parsing}
\include{sec/semantic_analysis}
\include{sec/intermediate_representation}
\include{sec/optimization}
\include{sec/backend}
% \include{sec/tbd}
% \include{sec/encapsulation}
% \include{sec/inheritance}
% \include{sec/composition}
% \include{sec/compiling}

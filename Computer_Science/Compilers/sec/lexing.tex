...
\subsection{Token Types}
  ...
  \begin{example}[Bang]
    The \texttt{!} character represents the \texttt{<BANG>} token. 
    \begin{enumerate}
      \item \textit{Negation}. In C, C++, and Java, we can take a boolean value and negate it, e.g. \texttt{!true}.
    \end{enumerate}
  \end{example}

  \begin{example}[Equal]
    The \texttt{<EQUAL>} token represents assignment. 
  \end{example} 

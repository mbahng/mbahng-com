\documentclass{article}
  ...
  % Page style
    \pagestyle{fancy}
    \fancyhead[L]{Data Structures and Algorithms}
...
\include{sec/intro}
\include{sec/array_based_data_structures}
\include{sec/hash_based_data_structures}
\include{sec/graph_based_data_structures}
\include{sec/brute_force}
\include{sec/greedy}
\include{sec/divide_and_conquer}
\include{sec/graph}
\include{sec/dynamic_programming}
\include{sec/probabilistic}
\include{sec/efficiency}
\include{sec/streaming}
\include{sec/linear}

  ...
  \begin{definition}[Memory, Buffer Pool]
    ...
    \begin{figure}[H]
      ...
      \begin{tikzpicture}[
        ...
        data/.style={rectangle, draw, minimum width=1.5cm, minimum height=1cm},
        stdout/.style={rectangle, draw, minimum width=1.5cm, minimum height=1.5cm}
        ]
      
        % Circular partitioned structure (left)
        \draw (0,0) circle (2cm);
        \draw (0,0) -- (0:2cm);
        \draw (0,0) -- (45:2cm);
        \draw (0,0) -- (90:2cm);
        ...
        % Partition labels (with blue color)
        \node[text=blue, draw, inner sep=1pt, font=\footnotesize] at (22.5:1.3cm) {0x13};
        \node[text=blue, draw, inner sep=1pt, font=\footnotesize] at (67.5:1.3cm) {0xAB};
        \node[text=blue, draw, inner sep=1pt, font=\footnotesize] at (157.5:1.3cm) {0x29F};
        \node[text=blue, draw, inner sep=1pt, font=\footnotesize] at (247.5:1.3cm) {0x41};
      
        % Small blue arrows inside partitions - REMOVED
        % Replaced with small boxes with memory addresses
      
        % Middle data grid - simplified to a single rectangle with partitions
        \node[rectangle, draw, minimum width=4cm, minimum height=2cm] (grid) at (5.5,0) {};
        \draw (5.5,-1) -- (5.5,1); % Vertical divider
        \draw (3.5,0) -- (7.5,0);  % Horizontal divider
        
        % Data grid cell labels
        \node at (4.5,0.7) {\textcolor{blue}{0xAB} \textcolor{red}{0}};
        \node at (4.5,0.3) {\small (Data...)};
        \node at (6.5,0.7) {\textcolor{blue}{0x13} \textcolor{red}{0}};
        \node at (6.5,0.3) {\small (Data...)};
        \node at (4.5,-0.7) {\textcolor{blue}{0x41} \textcolor{red}{0}};
        \node at (4.5,-0.3) {\small (Data...)};
        \node at (6.5,-0.7) {\textcolor{blue}{0x29F} \textcolor{red}{1}};
        \node at (6.5,-0.3) {\small (Data...)};
      
        % Right stdout box
        \node[stdout] (stdout) at (10,0) {stdout};
  ...
  \subsubsection{B-Trees}
    ...
    \begin{example}[Index Traversal in Tree]
      ...
      \begin{figure}[H]
        ...
        \begin{tikzpicture}[
          ...
          % Root node (level 0)
          \node (root) at (0,0) {100 ... 901};
          
          % Level 1 nodes - increased horizontal spacing
          \node (l1a) at (-5,-1.7) {100...192};
          \node (l1b) at (0,-1.7) {200...550};
          \node[draw=none] (new_key4) at (2.5,-1.7) {...};
          \node (l1c) at (5,-1.7) {901...996};
          
          % Level 2 nodes - increased horizontal spacing
          \node (l2a) at (-6.5,-3.4) {100...121};
          \node (l2b) at (-4,-3.4) {123...192};
          \node[draw=none] (new_key1) at (-5.25,-3.4) {...};
          
          \node (l2c) at (-1.25,-3.4) {200...300};
          \node (l2d) at (1.25,-3.4) {301...550};
          \node[draw=none] (new_key2) at (0,-3.4) {...};
          
          \node (l2e) at (4,-3.4) {901...950};
          \node (l2f) at (6.5,-3.4) {951...996};
          \node[draw=none] (new_key3) at (5.25,-3.4) {...};
          
          % Connect root to level 1
          \draw[->, orange, thick] (root) -- (l1a);
          \draw[->] (root) -- (l1b);
          \draw[->] (root) -- (l1c);
          
          % Connect level 1 to level 2 - each has exactly 2 children
          \draw[->] (l1a) -- (l2a);
          \draw[->, orange, thick] (l1a) -- (l2b);
          ...
          \draw[->] (l1c) -- (l2f); 
        \end{tikzpicture}
        \caption{An index tree of depth 3. If you want to look up 192, then you would traverse down the search tree.} 
    ...
    \begin{figure}[H]
      ...
      \begin{tikzpicture}[
        ...
        % Level 2 nodes - increased horizontal spacing
        \node (l2a) at (-6.5,-3.4) {100...\textcolor{orange}{121}};
        \node (l2b) at (-4,-3.4) {\textcolor{red}{123}...192};
        \node[draw=none] (new_key1) at (-5.25,-3.4) {...};
        ...
        \begin{tikzpicture}[
          ...
          two-slot/.style={
            append after command={
              \pgfextra{
                \draw ($(\tikzlastnode.north)!0.5!(\tikzlastnode.south)$) -- ($(\tikzlastnode.west)!0.5!(\tikzlastnode.east)$);
              }
            }
          },
          ...
          \node[two-slot] {50}
            % Level 1 nodes
            child {
              node[two-slot] {30 \hspace{0.1cm} 42}
              % Level 2 left subtree
              child {
                node[two-slot] {25 \hspace{0.1cm} 27}
                edge from parent node[left, draw=none, fill=none, text=black, font=\footnotesize] {$<30$}
              }
              child {
                node[two-slot] {35 \hspace{0.1cm} 39}
                edge from parent node[midway, draw=none, fill=none, text=black, font=\footnotesize] {$\geq30, <42$}
              }
              child {
                node[two-slot] {44 \hspace{0.1cm} 46}
                edge from parent node[right, draw=none, fill=none, text=black, font=\footnotesize] {$\geq42$}
              }
              edge from parent node[left, draw=none, fill=none, text=black, font=\footnotesize] {$<50$}
            }
            child {
              node[two-slot] {59 \hspace{0.1cm} 75}
              % Level 2 right subtree
              child {
                node[two-slot] {52 \hspace{0.1cm} 57}
                edge from parent node[left, draw=none, fill=none, text=black, font=\footnotesize] {$<59$}
              }
              child {
                node[two-slot] {60 \hspace{0.1cm} 70}
                edge from parent node[midway, draw=none, fill=none, text=black, font=\footnotesize] {$\geq59, <75$}
              }
              child {
                node[two-slot] {79 \hspace{0.1cm} 95}
                edge from parent node[right, draw=none, fill=none, text=black, font=\footnotesize] {$\geq75$}
              }
              edge from parent node[right, draw=none, fill=none, text=black, font=\footnotesize] {$\geq50$}
            };
        \end{tikzpicture}
  ...
  \subsubsection{B+ Trees}
        ...
        \begin{tikzpicture}[
          ...
          \node[two-slot] {50}
            ...
            child {
              ...
              % Level 2 left subtree
              child {
                node[two-slot] (leaf1) {25 \hspace{0.1cm} 27}
                edge from parent node[left, draw=none, fill=none, text=black, font=\footnotesize] {$<30$}
              }
              child {
                node[two-slot] (leaf2) {35 \hspace{0.1cm} 39}
                edge from parent node[midway, draw=none, fill=none, text=black, font=\footnotesize] {$\geq30, <42$}
              }
              child {
                node[two-slot] (leaf3) {44 \hspace{0.1cm} 46}
                edge from parent node[right, draw=none, fill=none, text=black, font=\footnotesize] {$\geq42$}
              }
              edge from parent node[left, draw=none, fill=none, text=black, font=\footnotesize] {$<50$}
            }
            child {
              ...
              % Level 2 right subtree
              child {
                node[two-slot] (leaf4) {52 \hspace{0.1cm} 57}
                edge from parent node[left, draw=none, fill=none, text=black, font=\footnotesize] {$<59$}
              }
              child {
                node[two-slot] (leaf5) {60 \hspace{0.1cm} 70}
                edge from parent node[midway, draw=none, fill=none, text=black, font=\footnotesize] {$\geq59, <75$}
              }
              child {
                node[two-slot] (leaf6) {79 \hspace{0.1cm} 95}
                edge from parent node[right, draw=none, fill=none, text=black, font=\footnotesize] {$\geq75$}
              }
              edge from parent node[right, draw=none, fill=none, text=black, font=\footnotesize] {$\geq50$}
            };
            
          % Horizontal connecting arrows between leaf nodes
          \draw[-latex] (leaf1.east) -- (leaf2.west);
          \draw[-latex] (leaf2.east) -- (leaf3.west);
          \draw[-latex] (leaf3.east) -- (leaf4.west);
          \draw[-latex] (leaf4.east) -- (leaf5.west);
          \draw[-latex] (leaf5.east) -- (leaf6.west);
          
          % Data pointers from leaf nodes (arrows pointing downward)
          % Leaf 1: 25, 27
          \draw[-latex] ($(leaf1.south) + (-0.4,0)$) -- ++(0,-0.4);
          \draw[-latex] ($(leaf1.south) + (0.4,0)$) -- ++(0,-0.4);
          
          % Leaf 2: 35, 39
          \draw[-latex] ($(leaf2.south) + (-0.4,0)$) -- ++(0,-0.4);
          \draw[-latex] ($(leaf2.south) + (0.4,0)$) -- ++(0,-0.4);
          
          % Leaf 3: 44, 46
          \draw[-latex] ($(leaf3.south) + (-0.4,0)$) -- ++(0,-0.4);
          \draw[-latex] ($(leaf3.south) + (0.4,0)$) -- ++(0,-0.4);
          
          % Leaf 4: 52, 57
          \draw[-latex] ($(leaf4.south) + (-0.4,0)$) -- ++(0,-0.4);
          \draw[-latex] ($(leaf4.south) + (0.4,0)$) -- ++(0,-0.4);
          
          % Leaf 5: 60, 70
          \draw[-latex] ($(leaf5.south) + (-0.4,0)$) -- ++(0,-0.4);
          \draw[-latex] ($(leaf5.south) + (0.4,0)$) -- ++(0,-0.4);
          
          % Leaf 6: 79, 95
          \draw[-latex] ($(leaf6.south) + (-0.4,0)$) -- ++(0,-0.4);
          \draw[-latex] ($(leaf6.south) + (0.4,0)$) -- ++(0,-0.4);
        \end{tikzpicture}
        \caption{The main difference is that the index nodes contain index entries, and the leaves are linked. Note that the 59, which represents both the index and the data value, are repeated. In here, we assume a block size of 2. The leaf nodes are the indices that point to the tuples in the disk/memory. Sometimes, we may store the tuple directly in the nodes, which saves us another level of indirection, but this may cause memory problems if the tuples have too many attributes.} 
        \label{fig:bp_tree} 
      \end{figure}
        ...
        \begin{figure}[H]
          ...
          \begin{subfigure}[b]{0.48\textwidth}
            ...
            \begin{tikzpicture}[
                node distance=1.5cm,
                every node/.style={font=\normalfont},
                bnode/.style={rectangle, draw, minimum height=0.6cm, minimum width=2.2cm}
              ]
              
              % Non-leaf node
              \node[bnode] (non_leaf) at (0,0) {$\;\;\;\;120 \quad 150 \quad 180\;\;\;\;$};
              
              % Arrows from non-leaf
              \draw[->, thick] ($(non_leaf.south)+(-1.1,0)$) -- +(-1.3,-0.9);
              \draw[->, thick] (non_leaf) -- +(-1.0,-1.3);
              \draw[->, thick] (non_leaf) -- +(1.0,-1.3);
              \draw[->, thick] ($(non_leaf.south)+(+1.1,0)$) -- +(1.3,-0.9);
              
            \end{tikzpicture}
            \caption{Non-leaf node of a B-tree with four child pointers and three separator keys}
            \label{fig:btree-nonleaf}
          \end{subfigure}
          \hfill 
          \begin{subfigure}[b]{0.48\textwidth}
            \centering
            \begin{tikzpicture}[
              ...
              % Leaf nodes with increased spacing
              \node[bnode] (leaf1) at (0.5,0) {100 \quad 101 \quad 110};
              \node[bnode] (leaf2) at (3.7,0) {120 \quad 130};
              
              % Arrows from first leaf node - repositioned below each number
              \draw[->, thick] (-0.5,-0.3) -- (-0.5,-0.8);
              \draw[->, thick] (0.5,-0.3) -- (0.5,-0.8);
              \draw[->, thick] (1.5,-0.3) -- (1.5,-0.8);
              
              % Arrows from second leaf node - repositioned below each number
              \draw[->, thick] (3.2,-0.3) -- (3.2,-0.8);
              \draw[->, thick] (4.2,-0.3) -- (4.2,-0.8);
              
              % Arrow between leaf nodes
              \draw[->, thick] (leaf1.east) -- (leaf2.west);
              
              % Arrow from last leaf node
              \draw[->, thick] (leaf2.east) -- +(0.6,0);
            \end{tikzpicture}
            \caption{Leaf nodes of a B-tree with pointers to data and links to adjacent leaves}
            \label{fig:btree-leaves}
          \end{subfigure}
    ...
    \begin{figure}[H]
      ...
      \begin{tabular}{|c|c|c|c|c|}
        \hline
        & \begin{tabular}{c} Max \# \\ pointers \end{tabular} & \begin{tabular}{c} Max \# \\ keys \end{tabular} & \begin{tabular}{c} Min \# \\ active pointers \end{tabular} & \begin{tabular}{c} Min \# \\ keys \end{tabular} \\
        \hline
    ...
    \begin{algo}[Lookup]
      ...
      \begin{figure}[H]
        ...
        \begin{tikzpicture}[
          ...
          % Level 1 nodes
          \node (l1a) at (-4.0,-1.8) {30};
          \node[multi-values] (l1b) at (2.5,-1.8) {120 \quad 150 \quad 180};
          
          % Level 2 nodes
          \node[multi-values] (l2a) at (-6.0,-3.6) {3 \quad 5 \quad 11};
          \node[multi-values] (l2b) at (-3.5,-3.6) {30 \quad 35};
          \node[multi-values] (l2c) at (-0.8,-3.6) {100 \quad 101 \quad 110};
          \node[multi-values] (l2d) at (1.9,-3.6) {120 \quad 130};
          \node[multi-values] (l2e) at (4.6,-3.6) {150 \quad 156 \quad 179};
          \node[multi-values] (l2f) at (7.3,-3.6) {180 \quad 200};
          
          % Arrows connecting the nodes - standard
          \draw[->] (root) -- (l1a);
          \draw[->, orange, thick] (root) -- (l1b);
          ...
          \draw[->] (l1b) -- (l2c);
          \draw[->] (l1b) -- (l2d);
          \draw[->, orange, thick] (l1b) -- (l2e);
          \draw[->] (l1b) -- (l2f);
          
          % Horizontal arrows connecting leaf nodes
          \draw[->] (l2a) -- (l2b);
          \draw[->] (l2b) -- (l2c);
          \draw[->] (l2c) -- (l2d);
          \draw[->] (l2d) -- (l2e);
          ...
          % Vertical arrows from leaf nodes - positioned precisely under each value
          % Node l2a (3,5,11)
          \draw[->] (-6.6,-4) -- (-6.6,-4.5);
          \draw[->] (-6.0,-4) -- (-6.0,-4.5);
          \draw[->] (-5.4,-4) -- (-5.4,-4.5);
          ...
          % Node l2e (150,156,179)
          \draw[->] (3.8,-4) -- (3.8,-4.5);
          \draw[->] (4.6,-4) -- (4.6,-4.5);
          \draw[->, orange, thick] (5.4,-4) -- (5.4,-4.5);
          
          % Node l2f (180,200)
          \draw[->] (6.8,-4) -- (6.8,-4.5);
          \draw[->] (7.8,-4) -- (7.8,-4.5);
        \end{tikzpicture}
        \caption{B-tree structure with nodes containing multiple values and pointers to child nodes. Leaf nodes have horizontal connections for sequential access and vertical pointers to data records. Note that the max fanout is 4.}
        \label{fig:fanout_ex}
      \end{figure}
    ...
    \begin{algo}[Insertion]
      ...
      \begin{figure}[H]
        ...
        \begin{tikzpicture}[
          ...
          % Level 1 nodes
          \node (l1a) at (-4.0,-1.8) {30 \quad \textcolor{orange}{\textbf{40}}};
          \node[multi-values] (l1b) at (2.5,-1.8) {120 \quad 150 \quad 180};
          
          % Level 2 nodes
          \node[multi-values] (l2a) at (-6.0,-3.6) {3 \quad 5 \quad 11};
          \node[multi-values] (l2b) at (-3.5,-3.6) {30 \quad 35 \quad \textcolor{orange}{\textbf{59}}};
          \node[multi-values] (l2c) at (-0.8,-3.6) {100 \quad 101 \quad 110};
          \node[multi-values] (l2d) at (1.9,-3.6) {120 \quad 130};
          \node[multi-values] (l2e) at (4.6,-3.6) {150 \quad 156 \quad 179};
          \node[multi-values] (l2f) at (7.3,-3.6) {180 \quad 200};
      ...
      \begin{enumerate}
        ...
        \begin{figure}[H]
          ...
          \begin{tikzpicture}[
            ...
            % Level 1 node
            \node[multi-values] (l1) at (3.5,-1.8) {120 \quad 150 \quad 180};
            
            % Level 2 nodes
            \node[multi-values] (l2a) at (0,-3.6) {100 \quad 101 \quad 110};
            \node[multi-values] (l2b) at (3,-3.6) {120 \quad 130};
            \node[multi-values] (l2c) at (6,-3.6) {150 \quad 156 \quad 179};
            \node[multi-values] (l2d) at (9,-3.6) {180 \quad 200};
            
            % New 152 value without a box
            \node[draw=none, font=\bfseries, text=red] (new_key) at (5.5,-4.4) {152};
            
            % Red arrow pointing to the space between 150 and 156
            \draw[->, red, thick] ($(new_key)+(0, 0.01)$) -- (5.5,-3.8);
            
            % Arrows connecting the nodes
            \draw[->] (root) -- ++(-2,-1.5);
            \draw[->, red, thick] (root) -- (l1);
            
            \draw[->] (l1) -- (l2a);
            \draw[->] (l1) -- (l2b);
            \draw[->, red, thick] (l1) -- (l2c);
            \draw[->] (l1) -- (l2d);
            ...
            % Vertical arrows from leaf nodes
            % Node l2a (100,101,110)
            \draw[->] (-1,-4) -- (-1,-4.5);
            \draw[->] (0,-4) -- (0,-4.5);
            \draw[->] (1,-4) -- (1,-4.5);
            ...
            \draw[->] (9.5,-4) -- (9.5,-4.5);
          \end{tikzpicture}
          \caption{If you try to add 152 into the tree, then it would overflow the leaf node. }
        ...
        \begin{figure}[H]
          ...
          \begin{tikzpicture}[
            ...
            % Level 2 nodes
            \node[multi-values] (l2a) at (-0.5,-3.6) {100 \quad 101 \quad 110};
            \node[multi-values] (l2b) at (2.5,-3.6) {120 \quad 130};
            
            % Split nodes - the original node has been split
            \node[multi-values, red] (l2c1) at (5,-3.6) {150 \quad 152};
            \node[multi-values, red] (l2c2) at (7.5,-3.6) {156 \quad 179};
            
            \node[multi-values] (l2d) at (10,-3.6) {180 \quad 200};
            
            % Value to be inserted - removed this as it's now inserted
            % \node[draw=none, font=\bfseries, text=red] (new_key) at (5.5,-4.4) {152};
            % \draw[->, red, thick] (new_key) -- (5.5,-3.8);
            ...
            \draw[->] (l2a) -- (l2b);
            \draw[->] (l2b) -- (l2c1);
            \draw[->] (l2c1) -- (l2c2);  % New connection between split nodes
            \draw[->] (l2c2) -- (l2d);
            ...
            % Node l2c1 (150, 152) - updated positions for split node
            \draw[->] (4.5,-4) -- (4.5,-4.5);
            \draw[->] (5.5,-4) -- (5.5,-4.5);
            
            % Node l2c2 (156, 179) - updated positions for split node
            \draw[->] (7,-4) -- (7,-4.5);
            \draw[->] (8,-4) -- (8,-4.5);
            
            % Node l2d (180,200)
            \draw[->] (9.5,-4) -- (9.5,-4.5);
            \draw[->] (10.5,-4) -- (10.5,-4.5);
          \end{tikzpicture}
          \caption{} 
        ...
        \begin{figure}[H]
          ...
          \begin{tikzpicture}[
            ...
            % Root node (level 0)
            \node (root) at (0,0) {100 \quad \textcolor{red}{156}};
            
            % Level 1 nodes - split
            \node[multi-values, red] (l1a) at (2,-1.8) {120 \quad 150};
            \node[multi-values, red] (l1b) at (6,-1.8) {180};
            ...
            \draw[->] (10.5,-4) -- (10.5,-4.5);
          \end{tikzpicture}
          \caption{You need to add to the parent node a pointer to the newly created node. } 
      ...
      \begin{enumerate}
        ...
        \begin{figure}[H]
          ...
          \begin{tikzpicture}[
            ...
            % Level 1 node
            \node[multi-values] (l1) at (3.5,-1.8) {120 \quad 156 \quad 180};
            
            % Level 2 nodes
            \node[multi-values] (l2a) at (0,-3.6) {100 \quad 101 \quad 110};
            \node[multi-values] (l2b) at (3,-3.6) {120 \quad 150};
            \node[multi-values] (l2c) at (5.5,-3.6) {156 \quad \textcolor{red}{\textbf{179}}};
            \node[multi-values] (l2d) at (8,-3.6) {180 \quad 200};
            ...
            \draw[->] (8.3,-4) -- (8.3,-4.5);
          \end{tikzpicture}
          \caption{If you try to delete 179 and take any index from the adjacent leaf nodes, they would be too empty as well!}
        ...
        \begin{figure}[H]
          ...
          \begin{tikzpicture}[
            ...
            % Level 1 node with red 180
            \node[multi-values] (l1) at (3.5,-1.8) {120 \quad 156 \quad \textcolor{red}{180}};
            
            % Cross out the 180 in level 1 node - removed X mark
            
            % Level 2 nodes
            \node[multi-values] (l2a) at (0,-3.6) {100 \quad 101 \quad 110};
            \node[multi-values] (l2b) at (3,-3.6) {120 \quad 150};
            \node[multi-values] (l2c) at (6,-3.6) {156 \quad 180 \quad 200};
            \node[multi-values, draw=red] (l2d) at (9,-3.6) {\quad};
            
            % Cross out the blank node - removed X mark
            ...
            % Arrow from l1 to l2d - fully red, no X mark
            \draw[->, red] (l1) -- (l2d);
            ...
            % Horizontal arrow from l2c to l2d - fully red, no X mark
            \draw[->, red] (l2c) -- (l2d);
            ...
            % Node l2c (156,180,200)
            \draw[->] (5.2,-4) -- (5.2,-4.5);
            \draw[->] (6.0,-4) -- (6.0,-4.5);
            \draw[->] (6.8,-4) -- (6.8,-4.5);
          \end{tikzpicture}
          \caption{You should merge the right node into the node with the deleted element, and then delete the nodes and pointers that are not needed (in red).}
          \label{fig:btree-deletion}
        \end{figure}
      ...
      \begin{figure}[H]
        ...
        \begin{subfigure}[b]{0.48\textwidth}
          ...
          \begin{tikzpicture}[
            ...
            % Leaf nodes in a sequence
            \node (l1) at (0,0) {\ldots};
            \node (l2) at (2,0) {\ldots};
            \node[draw=none] (l3) at (4,0) {\ldots};
            \node (l4) at (6,0) {\ldots};
            
            % Bidirectional arrows connecting leaf nodes
            \draw[<->] (l1) -- (l2);
            \draw[<->] (l2) -- (l3);
            \draw[<->] (l3) -- (l4);
            
            % Vertical arrows from each node
            \draw[->] (-0.3,-0.3) -- (-0.3,-1.2);
            \draw[->] (0,-0.3) -- (0,-1.2);
            \draw[->] (0.3,-0.3) -- (0.3,-1.2);
            \draw[->] (1.7,-0.3) -- (1.7,-1.2);
            \draw[->] (2,-0.3) -- (2,-1.2);
            \draw[->] (2.3,-0.3) -- (2.3,-1.2);
            \draw[->] (5.7,-0.3) -- (5.7,-1.2);
            \draw[->] (6,-0.3) -- (6,-1.2);
            \draw[->] (6.3,-0.3) -- (6.3,-1.2);
            
            \draw[thick] (-0.5,-1) rectangle (6.5,-1.7);
            \node[draw=none] at (3,-1.35) {Disk};
          \end{tikzpicture}
        ...
        \begin{subfigure}[b]{0.48\textwidth}
          ...
          \begin{tikzpicture}[
            ...
            \draw[->] (-0.3,-0.3) -- (6,-1.2);
            \draw[->] (0,-0.3) -- (4.3,-1.2);
            \draw[->] (0.3,-0.3) -- (1.2,-1.2);
            \draw[->] (1.7,-0.3) -- (1.7,-1.2);
            \draw[->] (2,-0.3) -- (2.9,-1.2);
            \draw[->] (2.3,-0.3) -- (1.3,-1.2);
            \draw[->] (5.7,-0.3) -- (3.7,-1.2);
            \draw[->] (6,-0.3) -- (3.4,-1.2);
            \draw[->] (6.3,-0.3) -- (1.9,-1.2);

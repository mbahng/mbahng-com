\documentclass{article}
  ...
  % packages
    ...
    \usepackage{xr-hyper}         % for hypertext linking
  ...
  % New and replaced operators
    ...
    \newcommand{\tderives}{\overset{\ast}{\Rightarrow}}
  ...
  \tikzset{
	...
	% external documents 
   \externaldocument[dsa-]{../DSA/paper}[https://mbahng.com/Computer_Science/DSA/paper.pdf] 


\begin{document}

\title{Automata, Computability, and Complexity Theory}
...
\include{sec/intro}
\include{sec/languages}
\include{sec/finite_boolean_computation}
\include{sec/regular_languages}
\include{sec/context_free_languages}
\include{sec/context_sensitive_languages}
\include{sec/turing_machines}
\include{sec/decidability}
\include{sec/reducibility}
\include{sec/time_complexity}
\include{sec/space_complexity}
\include{sec/intractability}
\include{sec/approximation_algorithms}
\include{sec/randomized_algorithms}

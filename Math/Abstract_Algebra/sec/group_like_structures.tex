...
\subsection{Group Homomorphisms}
  ...
  \begin{theorem}[Images and Kernels of Group Homomorphisms]
  ...
  \begin{theorem}[Compositions of Group Homomorphisms]
  ...
  \begin{theorem}[Properties of Group Isomorphisms]
  ...
  \begin{theorem}[Conjugate Shift is an Automorphism]
...
\subsection{Group Presentations} 
  ...
  \begin{theorem}[Preservation of Order in a Group Homomorphism]
...
\subsection{Symmetric and Alternating Groups}
  ...
  \begin{theorem}[Cycle Decomposition of Permutations]
  ...
  \begin{example}[Cyclic Decompositions]
  ...
  \begin{lemma}[Conjugation is Easy with Cycle Notation]
  ...
  \begin{corollary}[Transposition Decomposition of Permutations]
  ...
  \begin{lemma}[Parity of Transpositions]

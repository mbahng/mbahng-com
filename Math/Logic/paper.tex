\documentclass{article}
  ...
  % Custom Environments
    ...
    \NewDocumentEnvironment{axiom}{O{} o}{%
      ...
      \ifstrempty{#1}{%
        \begin{tcolorbox}[title=\textbf{Axiom \thetheorem}]%
      }{%
        \IfValueTF{#2}{%
          \begin{tcolorbox}[title=\textbf{Axiom \thetheorem~(#1)}, label={#2}]%
        }{%
          \begin{tcolorbox}[title=\textbf{Axiom \thetheorem~(#1)}]%
        }%
      }%
    }{%
      \end{tcolorbox}%
...
\include{sec/propositional}
\include{sec/first_order}
\include{sec/second_order}

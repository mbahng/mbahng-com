\documentclass{article}
  ...
  % packages
    ...
    \usepackage{extarrows, esvect, esint}
    ...
    \makeatletter
    \patchcmd{\pgfplotsforeachtodomain@@}{\ifnum}{\ifdim}{}{}
    \makeatother
    ...
    \hfuzz=20.002pt                % ignore overfull hbox badness warnings below this limit
  ...
  % external documents 
    \externaldocument[dsa-]{../../Computer_Science/DSA/paper}[https://mbahng.com/Computer_Science/DSA/paper.pdf]
    \externaldocument[alg-]{../Abstract_Algebra/paper}[https://mbahng.com//Math/Abstract_Algebra/paper.pdf]
    \externaldocument[top-]{../Point_Set_Topology/paper}[https://mbahng.com/Math/Point_Set_Topology/paper.pdf]
    \externaldocument[real-]{../Univariate_Analysis/paper}[https://mbahng.com/Math/Univariate_Analysis/paper.pdf]
    \externaldocument[la-]{../Linear_Algebra/paper}[https://mbahng.com/Math/Linear_Algebra/paper.pdf] 
...
\include{sec/intro}
\include{sec/differentiation}
\include{sec/higher_order_derivatives}
\include{sec/vector_fields}
\include{sec/integration}
\include{sec/surfaces}
\include{sec/forms}
\include{sec/sequences_of_functions}

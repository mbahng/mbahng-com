...
\subsection{Extrema}
  ...
  \begin{theorem}[Lagrange Multipliers Theorem]
		Let $f: \mathbb{R}^n \longrightarrow \mathbb{R}$ be a $C^1$ function and let $g: \mathbb{R}^n \to \mathbb{R}^c$ represent a system of constraint equations of the form $g(x) = 0$. If 
		\begin{equation}
			a = \max_{g(x) = 0} f(x)
		\end{equation}

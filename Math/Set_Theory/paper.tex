\documentclass{article}
  ...
  % Custom Environments
    ...
    \NewDocumentEnvironment{axiom}{O{} o}{%
      ...
      \ifstrempty{#1}{%
        \begin{tcolorbox}[title=\textbf{Axiom \theaxiom}]%
      }{%
        \IfValueTF{#2}{%
          \begin{tcolorbox}[title=\textbf{Axiom \theaxiom~(#1)}, label={#2}]%
        }{%
          \begin{tcolorbox}[title=\textbf{Axiom \theaxiom~(#1)}]%
        }%
      }%
    }{%
      \end{tcolorbox}%
  ...
  % external documents 
    ...
    \externaldocument[real-]{../Real_Analysis/paper}[https://mbahng.com/Math/Real_Analysis/paper.pdf] 
...
\include{sec/intro}
\include{sec/sets}
\include{sec/correspondences}
\include{sec/structures}
\include{sec/naturals}
\include{sec/sequences_of_sets}
\include{sec/integers_rationals}
\include{sec/reals}
\include{sec/complex}
\include{sec/cardinal_numbers} 
\include{sec/ordinal_numbers} 
\include{sec/axiom_of_choice}

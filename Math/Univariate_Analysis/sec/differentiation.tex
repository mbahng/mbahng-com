...
\subsection{Mean Value Theorem}
  ...
  \begin{theorem}[Derivative of a Monotonic Function]
    ...
    \begin{enumerate}
      \item $f^\prime (x) > 0 \implies f$ is strictly increasing
      \item $f^\prime (x) \geq 0 \iff f$ is increasing
      \item $f^\prime (x) = 0 \iff f$ is constant
      \item $f^\prime (x) \leq 0 \iff f$ is decreasing
      \item $f^\prime (x) < 0 \implies f$ is strictly decreasing
    \end{enumerate}
    ...
    \begin{enumerate}
      \item $f \text{ is strictly increasing} \implies f'(x) \geq 0$
      \item $f \text{ is strictly decreasing} \implies f'(x) \leq 0$
    \end{enumerate}
  \end{theorem}
  \begin{proof}

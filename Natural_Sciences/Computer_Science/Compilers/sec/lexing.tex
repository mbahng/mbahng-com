...
\subsection{Tokenizing} 
  ...
  \begin{enumerate}
    \item Take the longest match. 
    \item Rules have an ordering. 
  \end{enumerate}
  ...
  Lexers can have multiple DFAs, and depending on context (through start state), you traverse different DFAs (e.g. code vs comments). To see keyword vs identifier, you usually use a hashmap to check for keywords (e.g. \texttt{if} $\to$ \texttt{<IF>}), and if there are no matches, then you catch it with a regex. 

...
\include{sec/intro}
\include{sec/theory_of_relations}
\include{sec/design_theory}
\include{sec/sql}
\include{sec/index_b_trees}
\include{sec/query_processing}
\include{sec/xml}
\include{sec/json}
\include{sec/transactions}
\include{sec/big_data}

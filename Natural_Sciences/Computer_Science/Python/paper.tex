...
% To do  
% How naming works, scope, getting namespace  
...
\include{sec/lexical}
\include{sec/type}
\include{sec/primitives}
\include{sec/data_structures}
\include{sec/assignment}
\include{sec/loops}
\include{sec/functions}
\include{sec/classes}
\include{sec/decorators}
\include{sec/exception_handling}
\include{sec/packages}
\include{sec/inspect}

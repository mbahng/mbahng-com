\documentclass{article}
  ...
  % external documents 
    \externaldocument[dsa-]{../../Computer_Science/DSA/paper}[../../Computer_Science/DSA/paper.pdf]
    \externaldocument[alg-]{../Abstract_Algebra/paper}[../Abstract_Algebra/paper.pdf]
    \externaldocument[top-]{../Point_Set_Topology/paper}[../Point_Set_Topology/paper.pdf]
...
\include{sec/intro}
\include{sec/vector_spaces}
\include{sec/linear_maps}
\include{sec/metrics_norms_inner_products}
\include{sec/matrices}
\include{sec/determinants_trace}
\include{sec/spectral_theory}
\include{sec/further_properties}
\include{sec/numerical_methods}
\include{sec/tensors}
\include{sec/exercises}

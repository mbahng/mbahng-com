...
\subsection{Exercises} 
  ...
  \begin{exercise}[Royden 3.11]
    Let $f$ be a measurable function and $g$ be a one-to-one function from $\mathbf{R}$ onto $\mathbf{R}$ which has a Lipschitz inverse. Show that the composition $f \circ g$ is measurable. (Hint: Examine Problem 38 in Chapter 2.)
  \end{exercise}

  \begin{exercise}[Royden 3.12]

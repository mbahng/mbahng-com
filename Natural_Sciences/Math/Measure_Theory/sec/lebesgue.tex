...
\subsection{Nonmeasurable Sets} 
  ...
  \begin{theorem}[Pathological Strictly Increasing Devil's Staircase]
    \label{thm:pathological-devils-staircase}
...
\subsection{Exercises} 
  ...
  \begin{solution}
    ...
    \end{equation}
    Therefore, by upgrading countable subadditivity to countable additivity, we get the monotonicity property for free.  
  \end{solution}
  ...
  \end{exercise}
  \begin{solution}
    It is really hard to prove this directly. But we know that $m^\ast (\mathbb{Q}) = 0$ since rationals are countable, then by invoking excision, we get 
    \begin{equation}

...
\subsection{Lebesgue Outer Measure}
  ...
  \begin{lemma}[Finite Additivity for Outer Measure]
...
\subsection{Nonmeasurable Sets} 
  ...
  \begin{theorem}[Pathological Strictly Increasing Devil's Staircase]
...
\subsection{Exercises} 
  ...
  \end{exercise}
  \begin{solution}
    Proven in Theorem \ref{Finite Additivity for Outer Measure}
  \end{solution}

  \begin{exercise}[Royden 2.11]
  ...
  \end{exercise}
  \begin{solution}
    From the same logic as Exercise \ref{Royden 2.11}. 
  \end{solution}
  ...
  \end{exercise}
  \begin{solution}
    Note from Exercise \ref{Royden 2.7} that we can outer-approximate \textit{any} set with a $G_\delta$-set. Therefore, choose such a set $G \supset E$ which satisfies 
    \begin{equation}
      m^\ast (G) - m^\ast (E) = 0 
    \end{equation}

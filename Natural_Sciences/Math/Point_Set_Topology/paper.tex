...
\include{sec/intro}
\include{sec/open_closed_sets} 
\include{sec/common_topologies}
\include{sec/continuity}
\include{sec/induced_topologies}
\include{sec/metric_topologies}
\include{sec/connectedness}
\include{sec/compactness}
\include{sec/countability}
\include{sec/separability}
\include{sec/homotopies}

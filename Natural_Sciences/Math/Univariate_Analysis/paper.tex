\documentclass{article}
  ...
  % Page style
    \pagestyle{fancy}
    \fancyhead[L]{Univariate Real Analysis}
  ...
  % external documents 
    ...
    \externaldocument[mt-]{../Measure_Theory/paper}[../Measure_Theory/paper.pdf] 
...
\include{sec/intro}
\include{sec/reals} 
\include{sec/euclidean_topology} 
\include{sec/sequences} 
\include{sec/continuous_functions} 
\include{sec/differentiation} 
\include{sec/riemann_integration} 
\include{sec/sequences_of_functions}
\include{sec/analytic_functions}

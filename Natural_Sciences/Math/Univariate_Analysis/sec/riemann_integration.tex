\section{Riemann Integration} 
  ...
  We would like to define an integral. We do this by defining the Riemann sums for a particular partition, which is some number in $\mathbb{R}$. By taking lower and upper approximations and then taking the supremum and infimum of them, respectively, we can determine what it means for a function to be Riemann integrable. 
  ...
  \begin{definition}[Riemann Integral]
    ...
    Let $f: [a, b] \to \mathbb{R}$ be bounded. Then, the \textbf{upper and lower Rimemann integrals} of $f(x)$ are defined 
    \begin{equation}
  ...
  In some textbooks, we also define a \textit{partition with distinguished points} which simply is a partition $P$ along with some set of $\xi_i$'s that land in each interval. This allows for extra degrees of freedom for choosing points, but it is generally not needed here. 
...
\subsection{Axiomatic Properties of the Integral}

  The most important properties of integrable functions is linearity, additivity, and monotonicity. 
  ...
  \begin{lemma}[Restrictions of Integrable Functions]
  ...
  \begin{theorem}[Additivity of Riemann Integral]
...
\subsection{Further Properties of the Riemann Integral}
  ...
  This will later allow us to define inner products on function spaces.
  ...
  So, we can define a vector space. 
...
\subsection{The Fundamental Theorem of Calculus} 
  ...
  \begin{theorem}[Second Fundamental Theorem of Calculus]
    ...
    \begin{equation}
      \int_a^b f(x)\,dx  = \mathcal{F} \big|_a^b \coloneqq \mathcal{F}(b) - \mathcal{F}(a)
    \end{equation}
  ...
  \begin{proof}
    ...
    \begin{equation}
      \mathcal{F}(x) \coloneqq \int_a^x f(t)\,dt + \mathcal{F}(a)
    \end{equation}
...
\subsection{Change of Basis, aka u-Substitution}
...
\subsection{Improper Integrals}
  ...
  \begin{definition}[Improper Integral of Unbounded Interval]
    ...
    \begin{enumerate}
      \item If it is defined on $[a, +\infty)$ and is integrable on every closed interval $[a, b] \subset [a, +\infty)$, then we define 
        \begin{equation}
          \int_a^{+\infty} f(x)\,dx \coloneqq \lim_{b \rightarrow + \infty} \int_a^b f(x)\,dx
        \end{equation}

      \item If it is defined on $(-\infty, b]$ and is integrable on every closed interval $[a, b] \subset (-\infty, b]$, then we define 
        \begin{equation}
          \int_{-\infty}^b f(x)\,dx \coloneqq \lim_{a \rightarrow -\infty} \int_a^b f(x)\,dx
        \end{equation} 
      ...
      \item If it is defined on $\mathbb{R}$ and is integrable on every closed interval $[a, b] \subset \mathbb{R}$, then we define\footnote{Small technicality is that we have to prove that this is independent of the order in which we take the limits.} 
        \begin{equation}
          \int_{-\infty}^{+\infty} f(x)\,dx \coloneqq \lim_{b \rightarrow +\infty} \lim_{a \rightarrow -\infty} \int_a^b f(x)\,dx
        \end{equation} 
    \end{enumerate}
  ...
  \begin{lemma}
    ...
    \begin{equation}
      \mathcal{F}(b) \coloneqq \int_a^b f(x)\,dx
    \end{equation}

...
def create_html_file(nodes, edges, color_groups, output_dir):
    ...
    <body>
        ...
        <script>
            ...
            var node = g.append("g")
                ...
                .attr("class", "node")
                .attr("r", function(d) {
                    var radius = 20 + Math.sqrt(d.link_count);
                    return radius;
                })
    ...
    output_file = os.path.join(output_dir, 'ml_lit.html')
    with open(output_file, 'w', encoding='utf-8') as f:
        f.write(html_content)
    
    return os.path.abspath(output_file)

def create_html(vault_dir, output_dir):
    ...
    create_html_file(nodes, edges, color_groups, output_dir)

vault_dir = os.path.join('/', 'Users', 'mbahng', 'Research', 'literature') 
output_dir = os.path.join('/', 'Users', 'mbahng', 'Notes', 'mbahng-com', 'Research')
create_html(vault_dir, output_dir)

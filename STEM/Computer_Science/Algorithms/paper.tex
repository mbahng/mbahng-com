...
\section{Graphs}
        ...
        \begin{algorithmic}[1]
          ...
          \Function{Dijkstra}{s}
            ...
            \State (curr\_dist, curr\_node) $\gets$ pop from toExplore  \Comment{pop from toExplore}
              ...
              \For{neighbor, weight $\in E[curr]$} \Comment{Look at each neighbor}
  ...
  \subsection{Minimum Spanning Trees} 
    ...
    \subsubsection{Kruskal's Algorithm}
      ...
      \begin{algo}[Primitive Kruskal's Algorithm]

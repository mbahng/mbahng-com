...
\section{Divide and Conquer} 
  ...
  \subsection{Selection and Quick Sort} 
    ...
    \begin{algo}[Select kth smallest element from unsorted array]
      ...
      \begin{algorithm}[H]
        ...
        \begin{algorithmic}
          ...
          \Function{FindKthLargest}{nums, k}
              ...
              \State left $\gets$ [ ] \Comment{Array for elements smaller than pivot}
              \State right $\gets$ [ ] \Comment{Array for elements larger than pivot}
              ...
              \If{length(right) $\leq$ k - 1 \textbf{and} length(left) $\leq$ length(nums) - k}
                  \State \Return nums[pivot]
              \ElsIf{length(right) $\geq$ k}
                  \State \Return \Call{FindKthLargest}{right, k}
              \Else
                  \State \Return \Call{FindKthLargest}{left, k - length(right) - n\_pivots}
              \EndIf
          \EndFunction
        \end{algorithmic}
      \end{algorithm}

...
\subsection{Divisors and Reducibility} 
  ...
  \begin{definition}[Reducibility of Elements]
    Let $R$ be a commutative ring and $r \in R$ be nonzero and not a unit. Then $r$ is \textbf{irreducible}  in $R$ if whenever $r = ab$ with $a, b \in R$, at least one of $a, b$ is a unit in $R$. Otherwise, $r$ is said to be \textbf{reducible}. 
  \end{definition}
  ...
  \begin{lemma}[Euclid's Lemma, May Need PID For This]

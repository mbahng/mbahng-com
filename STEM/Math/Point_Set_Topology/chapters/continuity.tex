\section{Continuous Functions}
  ...
  Note that to check if $f$ is continuous, it suffices to check that the preimage of every basis element of the topology of $Y$ under $f$ is open in $X$, since every open set in $Y$ can be constructed as the union of basis elements and preimages preserve arbitrary unions. More rigorously, an arbitrary open set $V$ of $Y$ can be written as 
  \begin{equation}
...
\subsection{Homeomorphisms}
  ...
  \begin{example}[Homeomorphiosm Classes of 2D Manifolds]
  ...
  \begin{lemma}[Pasting Lemma, Gluing Lemma]
    ...
    \begin{figure}[H]
      \centering 
      \includegraphics[scale=0.4]{img/Gluing_Lemma.png}

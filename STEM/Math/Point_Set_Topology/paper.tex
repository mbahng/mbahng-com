...
\section{Topologies} 
  ...
  \subsection{Open Sets} 
    ...
    \begin{example}[Open Ball Topology on Line]
    ...
    Now that we've defined a topology and gave a few examples, we can talk about what it generally means for a point to be infinitesimally close to a set. 
  ...
  \subsection{Basis} 
    ...
    \begin{definition}[Basis Generated Topology]

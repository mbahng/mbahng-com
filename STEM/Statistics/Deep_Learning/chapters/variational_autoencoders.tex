\section{Variational Autoencoders}
  ...
  By the simplifying form that $q_\phi$ is a Gaussian, we can even get a nearly closed form of the ELBO. 
...
\subsection{Reparamaterization Trick} 
  ...
  \begin{figure}[H]
    ...
    \begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-1,xscale=1]
      ...
      \draw [shift={(164.33,62.11)}, rotate = 180.74] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
      %Curve Lines [id:da5962854824857341] 
      \draw    (216,118.33) .. controls (244.56,97.1) and (224.3,136.89) .. (259.36,113.24) ;
      \draw [shift={(261,112.11)}, rotate = 145.15] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
      %Straight Lines [id:da19986172160423643] 
      \draw    (422.09,93) -- (455.79,113.94) ;
      \draw [shift={(457.49,115)}, rotate = 211.86] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
      %Straight Lines [id:da563527517377988] 
      \draw    (421.67,139) -- (456.51,123.16) ;
      \draw [shift={(458.33,122.33)}, rotate = 155.56] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
      %Straight Lines [id:da9810030545590435] 
      \draw    (491.42,117.67) -- (523.67,118.09) ;
      \draw [shift={(525.67,118.11)}, rotate = 180.74] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
      %Curve Lines [id:da27917860120610793] 
      \draw    (540.67,106.33) .. controls (569.23,85.1) and (515.33,95.78) .. (549.38,71.26) ;
      \draw [shift={(551,70.11)}, rotate = 145.15] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
      %Straight Lines [id:da46048578655946304] 
      \draw    (558.75,120.33) -- (592.46,141.28) ;
      \draw [shift={(594.16,142.33)}, rotate = 211.86] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
      %Straight Lines [id:da4526948376904725] 
      \draw    (558.33,166.33) -- (593.18,150.49) ;
      \draw [shift={(595,149.67)}, rotate = 155.56] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
      %Straight Lines [id:da8633959975997318] 
      \draw    (291.42,63.67) -- (325.13,84.61) ;
      \draw [shift={(326.82,85.67)}, rotate = 211.86] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
      %Straight Lines [id:da9054037281263334] 
      \draw    (291,109.67) -- (325.85,93.83) ;
      \draw [shift={(327.67,93)}, rotate = 155.56] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
      %Straight Lines [id:da29559166512265533] 
      \draw    (358.09,91.67) -- (390.33,92.09) ;
      \draw [shift={(392.33,92.11)}, rotate = 180.74] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
      ...
      \draw (168.67,49.33) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle \phi ^{( i)} =\left( \mu _{\alpha }^{( i)} ,\ \sigma _{\alpha }^{( i)}\right)$};
      % Text Node
      \draw (216.67,125) node [anchor=north west][inner sep=0.75pt]  [font=\footnotesize] [align=left] {$\displaystyle \text{\text{sample}}$};
      % Text Node
      \draw (397.33,81) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle z^{( i)}$};
      % Text Node
      \draw (402.67,129.67) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle \beta $};
      % Text Node
      \draw (463.33,108) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle D_{\beta }$};
      % Text Node
      \draw (532.67,107) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle \theta ^{( i)}$};
      % Text Node
      \draw (494,80.33) node [anchor=north west][inner sep=0.75pt]  [font=\footnotesize] [align=left] {$\displaystyle \text{\text{sample}}$};
      % Text Node
      \draw (538.67,43) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle \hat{x}^{( i)}$};
      % Text Node
      \draw (536.67,157) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle x^{( i)}$};
      % Text Node
      \draw (602.67,135) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle \ell $};
      % Text Node
      \draw (266,103.67) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle \epsilon ^{( l)}$};
      % Text Node
      \draw (196.67,110.33) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle \epsilon$};
      % Text Node
      \draw (331.33,78.33) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle g_{\phi }$};
    \end{tikzpicture}
    \caption{Note that the $\epsilon$ variable was added into the graph. Therefore the path from $\ell$ to $\alpha$ does not directly go through a stochastic node. A similar figure can be found in Kigma's workshop presentation in NIPS. } 

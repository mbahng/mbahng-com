...
%    \renewcommand{\thefootnote}{\arabic{footnote}}
  ...
  % external documents 
    \externaldocument[dsa-]{../../Computer_Science/DSA/paper}[https://mbahng.com/Computer\_Science/DSA/paper.pdf]
...
\subsection{Score Matching} 
    ...
    \begin{theorem}[No Need for True Score to Optimize Fisher Divergence Objective]
  ...
  \subsubsection{Denoising Score Matching} 
    ...
    \begin{theorem}[Decomposition of Noisy Fisher Divergence]
    ...
    \begin{algo}[Denoised Score Matching]
  ...
  \subsubsection{Sliced Score Matching}
    ...
    \begin{definition}[Sliced Fisher Divergence]
    ...
    \begin{algo}[Sliced Score Matching]
      Now we are finally ready to present the algorithm. Note that in here, we never know the \textit{true} scores! 
      \begin{algorithm}[H]

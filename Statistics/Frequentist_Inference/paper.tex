\documentclass{article}
  ...
  % external documents 
    \externaldocument[meas-]{../../Math/Measure_Theory/paper}[https://mbahng.com/Math/Measure_Theory/paper.pdf] 
    \externaldocument[prob-]{../../Math/Probability_Theory/paper}[https://mbahng.com/Math/Probability_Theory/paper.pdf] 
...
\include{sec/intro} 
% \include{sec/point_estimation}
% \include{sec/hypothesis_testing}
% \include{sec/method_of_moments}
% \include{sec/maximum_likelihood} 
% \include{sec/bias_variance} 
% \include{sec/confidence_intervals}
% \include{sec/cross_validation}
% \include{sec/information_criteria}

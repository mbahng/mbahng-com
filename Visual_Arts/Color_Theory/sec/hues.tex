\section{Hues} 
  ...
  \begin{example}[Traditional RYB]
    ...
    \begin{figure}[H]
      ...
      \caption{This is the traditional artist's color wheel and represents the way the human eyes perceive color. } 
    \end{figure}
  \end{example}
...
\subsection{Complementary Colors}
  ...
  \begin{definition}[Complementary Colors]
  ...
  \begin{theorem}[Contrast in Complementary Colors]
    Complementary colors maximize contrast. 
  \end{theorem}

  \begin{theorem}[Mixing Complementary Colors]

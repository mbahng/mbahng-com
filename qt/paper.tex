...
\section{Option Contracts}
  ...
  \subsection{Contract Specifications}
    ...
    \subsubsection{Settlement}
      ...
      \begin{example}[Contrary Exercise]
...
\section{Volatility}
  ...
  \subsection{Volatility Splines/Surfaces}
    ...
    \begin{example}[Tick Matrix Examples]
    ...
    \begin{definition}[Up/Down Slope]
